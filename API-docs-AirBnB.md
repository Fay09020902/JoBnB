...
* Request
  ...
  * URL: /spots/:spotId/images/:imageId
  another option: /spot-images/:imageId
  * Body: none
...
* Request
  ...
  * URL: /reviews/:reviewId/images/:imageId
  another option: /review-images/:imageId
  * Body: none
...
* Request
  * Method: GET
  * URL: /spots?page={page}&size={size}&minLat={minLat}&maxLat={maxLat}&minLng={minLng}&maxLng={maxLng}&minPrice={minPrice}&maxPrice={maxPrice}
  * Query Parameters
